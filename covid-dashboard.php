...
.btn {
 ...
 <div class="main-content" style="background-color: #3160B8;" >
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                                ...
                                <div class="overview-item overview-item--c5">
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            ...
                                            <div class="text">
                                                <span style="font-size: 17px; color: white;">Himachal Pradesh Confirmed Cases</span>
                                ...
                                <div class="overview-item overview-item--recovered">
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            ...
                                            <div class="text">
                                                <span style="font-size: 17px;">Himachal Pradesh Recovered Cases</span>
                                ...
                                <div class="overview-item overview-item--death">
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            ...
                                            <div class="text">
                                                <span style="font-size: 17px;">Himachal Pradesh Death Cases</span>
                                                <h2 id="StateDeath"></h2>
                                            </div>
                                            <div class="progress">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <h2 class="title-1 m-b-25">Covid19 Cases In Himachal Pradesh</h2>
                            ...
                            <div class="col-lg-3">
                               ...
                               <div class="col-lg-12">
                                <h2 class="title-1 m-b-25">Covid19 Test Cases In Himachal Pradesh</h2>
                                <div class="table-responsive table--no-card m-b-40">
                            ...
                            <div class="col-lg-12">
                                <div class="au-card au-card--no-shadow au-card--no-pad m-b-40">
                                    <div class="au-card-title" >
                                        ...
                                        <h3>
                                            <i class="zmdi zmdi-account-calendar"></i>Corona Updates
                                        </h3>
                                       
                                    </div>
                                    <div class="au-task js-list-load">
                                        <div class="au-task__title">
                                            <h2>Testing Centers In Himachal Pradesh</h2>
                                        </div>
                                        <div class="au-task-list js-scrollbar3" id="testing">
                                            <div class="au-task__item au-task__item--danger">
                                                <div class="au-task__item-inner">
                                                    <iframe src="https://www.google.co.in/maps/d/embed?mid=1hpz15qb9NY43yz9ORbUQ85IRtSbMF4Hh" width="100%" height="480"></iframe>
                                                </div>
                                            </div>
                                        </div>
                                        <br><br>
...
$.ajax({
    ...
    var newArray = covid_data.states_tested_data.filter(function (el) {
      ...
      return el.state === 'Himachal Pradesh';
...
$.ajax({
    ...
    var conf_rate = (((StateConfirmed)*100)/(3241853));
...
$.ajax({
   ...
   //console.log(covid_data_zone.zones);
    ...
    var Greenlength = (Green.length/13)*100;
    ...
    document.getElementById("Greenzone-per").innerHTML = Greenlength;
     ...
     var Redlength = (Red.length/13)*100;
    ...
    var Orangelength =  (Orange.length/13)*100;
...
$.ajax({
   ...
   //console.log(covid_data_zone.zones);
    ...
    //console.log(Green.length); 
    var Greenlength = Math.round((Green.length/12)*100);
    document.getElementById("Greenzone-per").innerHTML = Greenlength;
     ...
     var Redlength = Math.round((Red.length/12)*100);
    document.getElementById("Redzone-per").innerHTML = Redlength;
    ...
    var Orangelength =  Math.round((Orange.length/12)*100);
    document.getElementById("Orangezone-per").innerHTML = Orangelength;

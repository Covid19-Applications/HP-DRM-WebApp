          ...
          <br><br><br><br>
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="bradcam_text">
                      <br><br>
                        <img src="img/responders/res.png" class="img-fluid" style="height: 450px;">
                    </div>
                </div>
            </div>
        </div>
		...
		<div class="container box_1170">
                         ...
                         <div class="card col-lg-12" style="padding: 25px;">
                                ...
                                <div class="table-responsive table--no-card m-b-40">
                                     <?php
                                                  $query = "SELECT * FROM police_emergency  WHERE state='himachal pradesh'";
                           ...
                           <div class="card col-lg-12"  style="padding: 25px;">
                                ...
                                <div class="table-responsive table--no-card m-b-40">
                                     <?php
                                                  $query = "SELECT * FROM ambulance_emergency WHERE state='himachal pradesh'";
                                                  $query_run = mysqli_query($connection, $query);
                                              ?>
                                    <table class="table table-borderless table-striped table-earning"  >
                                                <thead>
                         ...
                         <div class="card col-lg-12" style="padding: 25px;">
                                ...
                                <div class="table-responsive table--no-card m-b-40">
                                     <?php
                                                  $query = "SELECT * FROM fire_emergency WHERE state='himachal pradesh'";
                                                  $query_run = mysqli_query($connection, $query);
                                              ?>

...
$query = " INSERT INTO `donate_equipment`(`orgname`, `orgtype`, `email`, `phone`, `address`, `pincode`, `quantity`, `EquipmentType`, `shiptype`, `district`, `deltime`, `msg`) VALUES ( '$orgname', '$orgtype','$email', '$phone',  '$address', '$pincode' ,'$quantity','$EquipmentType', '$shiptype', '$district', '$deltime',  '$msg')";
...
$query = "INSERT INTO `employee`( `fullname`, `age`, `phone`, `email`, `field`) VALUES ( '$fullname' , '$age', '$phone', '$email', '$field')";
...
$query= "INSERT INTO `employer`(`fullname`, `email`, `phone`, `field`, `companyadd`, `companyname`) VALUES ('$fullname', '$email','$phone', '$field','$cname','$cadd')";
...
if(isset($_POST['hospitaladmbtn']))
{
    ...
    $query = "INSERT INTO hospitals_adm (Hospital, Address, Contact)  VALUES ('$hos','$add', '$con')";
    $query_run = mysqli_query($connection, $query);
...
if(isset($_POST['orphanageadmbtn']))
{
    ...
    $query = "INSERT INTO `orphan_adm`(`name`, `address`, `website`, `link`, `contact`) VALUES ('$name','$address','$website','$link','$number' )";
    $query_run = mysqli_query($connection, $query);
